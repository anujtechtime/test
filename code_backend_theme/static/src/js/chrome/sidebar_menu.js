odoo.define('code_backend_theme.SidebarMenu', function (require) {
    ...
    Menu.include({
        start() {
            ...
            $(".o_action_manager").css({'margin-left': '65px','transition':'all .1s linear'});
            $("#sidebar_panel").css({'width':'65px'});
            $("#sidebar_panel").css({'display':'block'});
            $(".top_heading").css({'margin-left': '65px'});
            $("#logo_img").css({'width':'65px'});
            return res, sideBar
        },
    });
    ...
    $(document).on("click", "#closeSidebar", function(event){
        $("#sidebar_panel").css({'width':'65px'});
        $("#logo_img").css({'width':'65px'});
        $(".o_action_manager").css({'margin-left': '65px'});
        $(".top_heading").css({'margin-left': '65px'});
