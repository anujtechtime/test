...
Theme.include({
    xmlDependencies: (Theme.prototype.xmlDependencies || [])
        .concat(['/theme_laze/static/src/xml/website_editor.xml']),
    events: {
        ...
        colorpicker.on('colorpicker:saved', this, function (ev) {
            ...
            // TODO improve to be more efficient
                ...
                if(colorName === 'laze'){
		            ...
		            var baseURL = '/laze_customize/static/src/scss/options/colors/color_picker.scss';                                
                     		self._rpc({
							    ...
							    self._rpc({
								    ...
								    params: {
								        url: '/laze_customize/static/src/scss/options/colors/color_picker.scss',
