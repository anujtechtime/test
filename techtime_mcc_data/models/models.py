                ...
                for lev in level_type:
                    ...
                    for shift in shift_data:
                        ...
                        if dept.department in  ("طب الاسنان", "الصيدلة") and shift == "afternoon":
                            ...
                            colld = 13
                            for ddts in data_one:
                                data_one_data = self.filtered(lambda picking:picking.level == lev and picking.department.id == dept.id and picking.shift == shift and picking.data_one.id == ddts.id and picking.fields_one_2 == True and picking.field_one_1 == False and picking.transferred_to_us == True and picking.Status == "currecnt_student" and picking.total_transferred_from_us == False)  
