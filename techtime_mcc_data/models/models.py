...
class ContractmDateAccount(models.Model):
    ...
    def _inverse_wage(self):
        ...
        if self.wage and self.day_deduction < 30:
            ...
            if float(self.wage) > 1750000:
                self.social_security = 1750000 * 0.05
            else:
                self.social_security = float(self.wage) * 0.05
            ...
            if self.employ_type != 'option1':
                if self.social_security >= 87500:
                    ...
                    if self.married_with_working_wife:
                        self.total_salary = 87500 + self.compensation + 208333
                    if self.married_with_non_working_husband:
                        self.total_salary = 87500 + self.compensation + 416666
