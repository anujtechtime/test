...
class ReportTrialBalancepagetwo(models.AbstractModel):
    ...
    def _get_accounts(self, accounts, display_account, date_from, date_to):
        ...
        requested = (
            ...
            "SUM(CASE WHEN " + (int(date_from[:4]) - 1) + " = EXTRACT(YEAR FROM CURRENT_DATE) - 1 THEN account_move_line.debit - account_move_line.credit ELSE 0 END) AS prev_year_balance, "
