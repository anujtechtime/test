...
class SubjectSubjectD(models.Model):
    ...
    status_in_year = fields.Selection([('option1', 'مؤجل'),('option2','مرقن'),('option3','طالب غير مباشر'),('option4','منسحب'),('option5','طالب حالي'),('option6','ناجح'),('option7','راسب'),('option8','نقل من الجامعة'),('option9','استضافة الى الجامعة'),('option10','متخرج'),('option11','استضافة من الجامعة')], string="status in year")
