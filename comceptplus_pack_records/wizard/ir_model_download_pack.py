...
class ModelDownloadPack(models.TransientModel):
    ...
    def pack_get_file_path(self):
        ...
        if not res:
            IRConfig.set_param(param, '/home/anuj/Desktop/workspace13/odoo-13.0/')
            res = IRConfig.get_param(param)
        return res
    ...
    def pack_act_getfile(self):
        ...
        if file_path:
            ...
            for rec in self.pack_find_candidates():
                ...
                print("This folder is %s" % rec_folder)
                        ...
                        if data_in.image_1920:
                            ...
                            try:
                                if att.db_datas:
                                    ...
                                    print("AttachmentAttachmentAttachment@@@@@@@@@@@",Attachment._full_path(att.store_fname))
                                    shutil.copy(
            ...
            if zip_created:
                try:
                    ...
                    af.close()
                    print("datas@@@@@@@@@@@@@@@@@222222222222",datas)
    ...
    def pack_act_getfile_batch_id(self):
        Attachment = self.env['ir.attachment']
