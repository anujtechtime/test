...
var ListController = BasicController.extend({
    ...
    events: _.extend({}, BasicController.prototype.events, {
        ...
        'click .o_list_export_pdf': '_onDownloadData',
    }),
...
_onDownloadData() {
        ...
        globalThis.value1 = this
        var query = this._rpc({
            model: 'stock.quant',
            method: 'action_view_quants_active_ids',
            args: [],
        }).then(function(vars) {
            var text = 0;
        ...
        var reportname = 'curr_inv_report_10.curr_inv_report_pdf_report?docids=' +
                          text +
        ...
        var action = {
            ...
            'report_file': 'curr_inv_report_10.curr_inv_report_pdf_report',
        };
        return globalThis.value1.do_action(action);
