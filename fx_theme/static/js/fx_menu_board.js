odoo.define('fx_theme.menu_board', function (require) {
    "use strict";
    ...
    var FxMenuBoard = Widget.extend({
        template: 'fx.menu_board',
        ...
        //     var right = this.getParent().$('.navigation-menu-tab-body').get(0)
        //     dragula([left, right], {
        ...
        //         $cloneItem.addClass('fx_nav_bar_app_item')
        //     }).on('drop', function (el, target, source, sibling) {
        //         if (target == right && source == left) {
        //             self.trigger_up('fx_favorite_app_dropped', { el: el });
        //         } else if (target == right && source == right) {
        //             self.trigger_up('fx_update_favorite');
        //         }
        ...
        _render: function () {
            this.$content_container.html(core.qweb.render('fx.board_content', { widget: this }));
